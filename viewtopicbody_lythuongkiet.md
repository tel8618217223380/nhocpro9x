...
$(".post-entry:first").after('<ul id="cungchuyenmuc"><a href="/f{FORUM_ID}-forum" style="color:#333;text-decoration:none!important;font:bold 13px tahoma">Bài vi?t cùng chuyên m?c :
...
<strong style="float: right; background: #2ebcff;padding: 2px;color: #fff;min-width:15px;height: 15px;font-size: 12px;text-align: center;-webkit-border-radius: 99px;  -moz-border-radius: 99px;  border-radius: 99px;position: relative;top: 1px;">Bài vi?t :{postrow.displayed.COUNT_POSTS}
...
<td>
<span class="avatar97">{postrow.displayed.POSTER_AVATAR}
...
<span class="user" style="float:right">{postrow.displayed.POSTER_NAME}
...
<div class="rank">{postrow.displayed.RANK_IMAGE}

Unknown end tag for &lt;/div&gt;


<fieldset style="width: 125px; border: 1px solid; margin: 5px; padding: 5px 10px;"><legend>Danh hi?u
...
<script>shop(<!-- BEGIN profile_field -->'{postrow.displayed.profile_field.CONTENT}',<!-- END profile_field -->1);
...
<span class="prone d{postrow.displayed.U_POST_ID}"><!-- BEGIN profile_field --><div class="thongtin" align="left">{postrow.displayed.profile_field.LABEL}<span class="dulieu">{postrow.displayed.profile_field.CONTENT}
...
<div class="uparrowdiv" style="padding: 10px;">{postrow.displayed.MESSAGE}
...
<!-- BEGIN switch_vote -->
<a target="v{postrow.displayed.U_POST_ID}" href="{postrow.displayed.switch_vote_active.switch_vote.U_VOTE_PLUS}" alt="c3zplus" class="c3zplus lvote"><span style="margin-left: -2px; color: #3B5998;">Thích
...
<!-- BEGIN switch_vote -->
<a target="v{postrow.displayed.U_POST_ID}" href="{postrow.displayed.switch_vote_active.switch_vote.U_VOTE_MINUS}" alt="c3zminus" class="c3zminus lvote"><span style="margin-left: -2px; color: #3B5998;">Không Thích
...
<div id="v{postrow.displayed.U_POST_ID}" class="loadding" style="display: none"><img src="http://i43.servimg.com/u/f43/16/03/04/56/icon_l12.gif"> Cám On B?n Ðã Ðánh Giá Bài Vi?t! 
...
<div class="main-content1">
<div id="specificatii_center" align="center"><ul id="specificatii"><li>•  Không spam. Xem rõ n?i quy chung <a href="/t9-topic" rel="nofollow"><strong>T?i Ðây
...
<li>• Th? hi?n van hóa b?ng cách b?m Like v?i các bài vi?t b?n thích.
...
<div  class="imgloadpost"  style="display:none;"><img src="http://i43.servimg.com/u/f43/16/03/04/56/icon_l12.gif"/>Ðang g?i....
...
<p class="h2" style="width: 220px !important">Quy?n h?n c?a b?n:
...
$(this).parents(".baigui").html('<div id=tbpost align=center>Ðã xóa kh?i co s? d? li?u
...
$('<div class=postcuoi><div  align=center><img src="http://i43.servimg.com/u/f43/16/03/04/56/icon_l12.gif"/>Ðang g?i bài vi?t.....
...
" : "",b = Math.round(100 * b);return "<span class=no>" + d + c + a + "

Unknown end tag for &lt;/span&gt;

 <span class=qua>Ðánh giá: " + b + "%

Unknown end tag for &lt;/span&gt;

"}$(".lvote").click(function () {"c3zplus" == $(this).attr("alt") ? $(this).parent().html("").next().html("") : $(this).parent().html("").prev().html("");var a = $(this).attr("target"),b = $(this).attr("alt"),d = $("." + a).attr("title");$("#" + a).show();$("." + a).html(chvote(b, d));$("#" + a).fadeIn("slow").animate({opacity: 1}, 1500).fadeOut("slow", function () {$("." + a).fadeOut("slow").animate({opacity: 1}, 1E3).fadeIn()});$("." + $(this).attr("target")).removeAttr("title")});
