...
Unknown end tag for &lt;/table&gt;
 ...
 <div class="boxcontents"><table width="100%"cellspacing="0" cellpadding="0" border="0" style="padding-bottom:5px;padding-top:5px;padding-left:10px;padding-right:5px" class="alt1" id="ba{FORUM_ID}"><tr><td style="width:600px; border: 1px solid #D4D4D4" valign="top">

<div class="bai_new2"><!-- BEGIN row --><!-- BEGIN topic -->
<div id="vovanan966">

<div class="bai_new3"><span class="baimoiblog"><div class="hien_thi"><div class="avatarcp"><a href="{topics_blog_box.row.U_VIEW_TOPIC}">{topics_blog_box.row.FIRST_POST_TEXT}
...
<a href="{topics_blog_box.row.U_VIEW_TOPIC}" class="an_phutu"><span class="ptspan12">{topics_blog_box.row.TOPIC_TITLE}
...
<a href="{topics_blog_box.row.U_VIEW_TOPIC}" class="an_phutu1" target="_blank">{topics_blog_box.row.TOPIC_TITLE}
...
{topics_blog_box.row.FIRST_POST_DMY_VALUE2}) Trả lời {topics_blog_box.row.REPLIES} | Xem {topics_blog_box.row.VIEWS}

Unknown end tag for &lt;/div&gt;

<div id="hinh" class="krokodil">
...
<script>var a=Math.floor((Math.random()*4)+3);$(function() {$('<span class="bv" />').load('/f2p'+a+'5-forum .blog_tintuc li:not(".blog_tintuc li:contains(\'Chú ý\'),.blog_tintuc li:gt(8)")', {limit: 10}, function() {jQuery(this).hide().appendTo('.baiviet').fadeIn(1);});return false;});
...
<script>$(function() {var fixadent = $("#fixadent"), pos = fixadent.offset();$(window).scroll(function() { if($(this).scrollTop() > (pos.top + 10) && $(this).scrollTop() < 15000 && fixadent.css('position') == 'static') { fixadent.addClass('fixed');  } else if($(this).scrollTop() <= pos.top && fixadent.hasClass('fixed')){ fixadent.removeClass('fixed'); }else if($(this).scrollTop() > 15000 && fixadent.hasClass('fixed')){ fixadent.removeClass('fixed'); }})});

Unknown end tag for &lt;/script&gt;


<script>$(function() {var fixadent1 = $("#fixadent1"), pos = fixadent1.offset();$(window).scroll(function() { if($(this).scrollTop() > (pos.top + 10) && $(this).scrollTop() < 15000 && fixadent1.css('position') == 'static') { fixadent1.addClass('fixed1');  } else if($(this).scrollTop() <= pos.top && fixadent1.hasClass('fixed1')){ fixadent1.removeClass('fixed1'); }else if($(this).scrollTop() > 15000 && fixadent1.hasClass('fixed11')){ fixadent1.removeClass('fixed1'); }})});
...
<div class="pt_xemthem"><a href="#xemthem">Xem thêm 
...
<div align="left">{postrow.displayed.ICON} <font color="#ba3814"  style="font-size:17px;"><b>{postrow.displayed.POST_SUBJECT}
...
<span style="float:right;display:inline-block;border:1px solid #b0b0b0;width:50px;height:50px;margin-top:-3px" id="avatar_1">{postrow.displayed.POSTER_AVATAR}
...
by {postrow.displayed.POSTER_NAME}
...
<div id="fixadent1" style="border:1px solid #d4d4d4;padding:8px 6px;margin-bottom:4px;height:20px;overflow:hidden;background-color:#f7f7f7" class=""><span style="float:left;font:bold 13px Tahoma;color:red;margin-right:4px;margin-top:1px">Thích bài này? 

Unknown end tag for &lt;/span&gt;

<span style="height: 20px; width: 78px;"><iframe src="http://www.facebook.com/plugins/like.php?href={FORUM_URL}{TOPIC_URL}&layout=button_count&show_faces=false&width=450&action=like&colorscheme=light&height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:auto; height:21px;" allowTransparency="true">
...
<span style="margin-top:1px;margin-left:5px;display:inline-block;width:75px;height:18px;float:left;background:url(http://i11.servimg.com/u/f11/17/98/19/05/110.png)no-repeat left top"><div style="width:43px;height:16px;float:left"> <span class="gensmall"><span id="z1127630"> 
...
<img src="http://i48.servimg.com/u/f48/16/18/15/10/downlo10.gif"> <a class="postlink" href="{postrow.displayed.switch_attachments.switch_post_attachments.switch_dl_att.U_ATTACHMENT}">{postrow.displayed.switch_attachments.switch_post_attachments.switch_dl_att.ATTACHMENT}

Unknown end tag for &lt;/a&gt;

 ({postrow.displayed.switch_attachments.switch_post_attachments.FILE_SIZE} , {postrow.displayed.switch_attachments.switch_post_attachments.NB_DL})<br/><br/>
<!-- END switch_dl_att -->
...
<dd>                                 .<em>{postrow.displayed.switch_attachments.switch_post_attachments.switch_no_comment.ATTACHMENT_COMMENT}
...
<img src="http://i48.servimg.com/u/f48/16/18/15/10/downlo10.gif"> <em><a href="/login">Bạn cần đăng nhập để tải file này
...
<!-- END switch_attachments --><a name="xemthem">
...
<div style="font: 22px normal Times New Roman;vertical-align: baseline;margin-left:10px;"><a href="/f{FORUM_ID}-" style="color:#ba3814;text-decoration:none!important;">Tin mới cập nhật :
...
<div class="baivieta1" style="overflow:hidden;width:100%; height:308px; border-top: 0px none;margin-left:10px;"><ul id="cungchuyenmuc">
...
<div align="right">  {postrow.displayed.EDIT_IMG}  {postrow.displayed.DELETE_IMG}
...
<div style=" float: left;" class="phutu_html5">

Unknown end tag for &lt;/div&gt;

   <div style=" float: right;" class="pagination"><span class="pagination">{PAGINATION}
...
<iframe name="vzt{comment.displayed.U_POST_ID}v" height="0" frameborder="0"width="0"></iframe><!-- END switch_vote --><!-- END switch_vote_active -->
...
<iframe name="vz{comment.displayed.U_POST_ID}v" height="0" frameborder="0"width="0"></iframe><!-- END switch_vote --><!-- END switch_vote_active -->
...
">{comment.displayed.POSTER_NAME} <span style="font-size:10px"><img src="{comment.displayed.MINI_POST_IMG}" alt="{comment.displayed.L_MINI_POST_ALT}" title="{comment.displayed.L_MINI_POST_ALT}" width="10" height="10"border="0" />{comment.displayed.POST_DATE_NEW}

Unknown end tag for &lt;/span&gt;

 {comment.displayed.L_ONLINE}<div><div class="postbodyc">
...
<div align="right">{comment.displayed.QUOTE_IMG} {comment.displayed.EDIT_IMG} {comment.displayed.DELETE_IMG} 
...
Unknown end tag for &lt;/div&gt;
   ...
   <!-- END displayed --><!-- END comment --><!-- BEGIN no_comment -->
<div style="background-color:#ffffff;width:100%;
border : 1px solid #cccccc;padding: 10px;" align="center">
<span class="genmed">{no_comment.L_NO_COMMENT}
...
<!-- END hidden -->   <div style=" float: left;" class="pagination"><span class="pagination">{PAGINATION}
...
<td style="float: right" style="float: right;width:320px" valign="top">
<div class="vovananvip"><iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FGiaiTriGiaoLuu9x&amp;width=292&amp;height=220&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;border_color&amp;header=true" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:292px; height:220px;" allowTransparency="true">
...
Unknown end tag for &lt;/div&gt;
 ...
 <div class="doc_trai"> <div class="doc_phai"> <div class="doc_duoi"> <div style="padding-left:8px; padding-right:8px;"><table class="forumline" width="100%" border="0" cellpadding="0" cellspacing="1"><tr><th align="left" width="100%" nowrap="nowrap"><span style="float:left"> <img src="http://i48.servimg.com/u/f48/14/28/30/23/3drigh10.png"> Chủ đề liên quan 

Unknown end tag for &lt;/span&gt;

<span style="float:right"><a href="/f{FORUM_ID}-"><img src="http://i48.servimg.com/u/f48/16/18/15/10/untitl95.png">
...
<tr>
<td width="100%" class="row1" id="row1"><div class="baiviet" style="overflow:hidden;width:290px;height:504px;padding:0px 0px" id="baiviet1"><span class="bv" style="">
...
<script>$(function () {$.ajax({url: "/feed/?f={FORUM_ID}",success: function (a) {$(".baivieta1").html('<ul id="cungchuyenmuc">');11 < $(a).find("title").length ? so = 17 : so = $(a).find("title").length;for (i = 2; i < so; i++) $('<li><a href="' + $(a).find("link:eq(" + i + ")").text() + '">' + $(a).find("title:eq(" + i + ")").text() + "
...
<script>var a=Math.floor((Math.random()*6)+1);$(function() {$('<span class="bv" />').load('/f{FORUM_ID}-'+a+'5-forum .baimoiblog:not("#blog_tintuc:contains(\'Chú ý\'),.baimoiblog:gt(9)")', {limit: 10}, function() {jQuery(this).hide().appendTo('.baiviet').fadeIn(1);});return false;});
