![http://i49.servimg.com/u/f49/17/49/58/89/114.jpg](http://i49.servimg.com/u/f49/17/49/58/89/114.jpg)
...
<a href="{U_POST_NEW_TOPIC}" rel="nofollow" class="button small green rounded" id="newtopic"><b>New Topic
...
<a href="{U_POST_REPLY_TOPIC}" class="button small blue rounded" id="newtopic"><b>Relpy Topic
...
<!-- BEGIN switch_user_authreply -->
<a href="{U_POST_REPLY_TOPIC}" class="button small blue rounded" id="newtopic"><b>Reply Topic
