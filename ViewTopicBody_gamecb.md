![http://i47.servimg.com/u/f47/17/87/12/55/vew10.png](http://i47.servimg.com/u/f47/17/87/12/55/vew10.png)
...
.messageUserBlock {
background: #393939 url('http://gamecb.net/styles/flexiledark/xenforo/gradients/tab-selected-light.png') repeat-x bottom;
...
<div style="float: left; left:210px;position:absolute;top:1px;">
<!-- BEGIN switch_vote_active -->
...
<div id="v{postrow.displayed.U_POST_ID}" class="loadding" style="display: none"><img src="http://i43.servimg.com/u/f43/16/03/04/56/icon_l12.gif"> Cảm ơn bạn đã bình chọn ! 
...
<div class="hihi clearfix" ><font color="black">
<!-- BEGIN switch_vote_active -->
...
border-bottom-left-radius: 10px 0 0 10px;
border-radius: 10px 0 0 10px;
