...
<iframe src="http://www.facebook.com/plugins/like.php?href={FORUM_URL}{TOPIC_URL}&amp;layout=button_count&amp;show_faces=false&amp;width=100&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true">
...
<td align="right" width="9%" class="browse-arrows"><a href="{U_VIEW_OLDER_TOPIC}">{L_VIEW_PREVIOUS_TOPIC}
...
<tr>
<td class="p2" class="alt2=">{postrow.displayed.POSTER_AVATAR}
...
<td align="center" class="t-title"><a name="bottomtitle">
...
<tr>
<td class="alt1" valign="top" {COLSPAN_PAGINATION} width="150"><span class="gensmall">{PAGE_NUMBER}
...
<!-- BEGIN topicpagination -->
<td class="alt1" align="right" valign="top" ><span class="gensmall">{PAGINATION}
...
<!-- BEGIN watchtopic -->
<tr>
<td class="alt1" colspan="2" align="right" valign="top"><span class="gensmall">{S_WATCH_TOPIC}
...
<tr>
<td valign="top">
<h1 class="cattitle"> {L_FORUM_RULES}
...
<tr>
<td class="alt1" valign="top" width="25%"><span class="gensmall">{L_TABS_PERMISSIONS}
...
<td class="alt1" valign="top" width="75%"><span class="gensmall">{S_AUTH_LIST}
...
<span class="gen">{L_MOD_TOOLS}<br />{S_SELECT_MOD} <input class="liteoption" type="submit" value="{L_GO}" />
