![http://i43.servimg.com/u/f43/15/23/22/46/demo_410.jpg](http://i43.servimg.com/u/f43/15/23/22/46/demo_410.jpg)
...
<p class="posting" style="float: none;margin-bottom: 5px;">
...
<div class="user"><div class="arrow">

Unknown end tag for &lt;/div&gt;


<div class="user-ident">
<div class="username">{postrow.displayed.POSTER_NAME}<br/><span style="font-weight: normal;font-size: 11px;">{postrow.displayed.POSTER_RANK_NEW}
...
<p style="padding: 5px 0;">  <b>{postrow.displayed.ICON} <a href="{postrow.displayed.POST_URL}">{postrow.displayed.POST_SUBJECT}
...
<hr style="width: 97%;border: none;  border-bottom: 1px solid #c8c8c8;">                <div class="post-entry">
...
<!-- END switch_no_dl_att -->                                                                <dd>({postrow.displayed.switch_attachments.switch_post_attachments.FILE_SIZE}) {postrow.displayed.switch_attachments.switch_post_attachments.NB_DL}
...
<p style=" text-align: center;">                        <a href="{U_VIEW_OLDER_TOPIC}">« Xem bài viết trước

Unknown end tag for &lt;/a&gt;

  |  <a href="{U_VIEW_NEWER_TOPIC}">Xem bài viết kế tiếp »
