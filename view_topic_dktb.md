...
<div style="display:none">  <a title="FMvi" target="_blank" rel="nofollow" href="http://www.fmvi.vn" name="bottom" class="skinfmvi2">&copy; <font color="green">FMvi
...
<center> <div class="js-kit-rating" title="" permalink="">
...
<script src="http://forumotion.googlecode.com/files/vote.js">
...
<div class="morelink">
<a target="_blank" class="Upro5"><img alt="Tường nhà" src="http://i36.servimg.com/u/f36/17/76/06/16/profil11.png" />Tường nhà

Unknown end tag for &lt;/a&gt;


<a target="_blank" class="Utopic"><img alt="Xem bài viết" src="http://i36.servimg.com/u/f36/17/76/06/16/total_10.gif" />Bài viết

Unknown end tag for &lt;/a&gt;


<a target="_blank" class="Ufrien"><img alt="Kết bạn" src="http://i36.servimg.com/u/f36/17/76/06/16/friend10.png" />Kết bạn

Unknown end tag for &lt;/a&gt;


<a target="_blank" onClick="javascript:alert('Đang phát triển')" class="Umoney"><img alt="Tài sản" src="http://i36.servimg.com/u/f36/17/76/06/16/table_10.png" />Tài sản
...
<div class="sig-content"><div class="noidungchuky">{postrow.displayed.SIGNATURE_NEW}
...
<a class="a2a_dd" href="http://www.addtoany.com/share_save#url=http://dktb.net{TOPIC_URL}"><img title="Share" src="http://i46.servimg.com/u/f46/17/56/78/10/kqkqh10.png" alt="Share" border="0">

Unknown end tag for &lt;/a&gt;



<script type="text/javascript" src="/54692.js">
...
<input value="http://dktb.net{TOPIC_URL}" onclick="this.select()" style="font-family: Arial,Sans-Serif; font-size: 13px; display: block; padding: 1px 1px 1px 20px; border: 1px solid rgb(133, 177, 222); width: 200px; background-color: rgb(237, 242, 247); background-image: url(&quot;http://i.imgur.com/9CncG.png&quot;); background-repeat: no-repeat; font-weight: bold;" title="Gửi cho bạn bè bài viết này" type="text">

Unknown end tag for &lt;/center&gt;



<a title="Gửi qua yahoo" href="ymsgr:im?+&amp;msg=Xem%20b%C3%A0i%20n%C3%A0y%20hay%20l%E1%BA%AFm%20n%C3%A8: ~~&gt;http://dktb.net{TOPIC_URL}"><img src="http://i.imgur.com/CdL9G.jpg" border="0">

Unknown end tag for &lt;/a&gt;


<br>
<a title="Bookmark lại bài này" href="javascript:bookmarksite('', 'http://dktb.net{TOPIC_URL}')"><img src="http://i46.servimg.com/u/f46/16/46/16/61/favori10.png" border="0">
...
<a title="Đăng lên Google" target="_blank" href="https://www.google.com.vn/bookmarks/mark?op=add&amp;bkmk=http://dktb.net{TOPIC_URL}&amp;title=&amp;annotation="><img src="http://i46.servimg.com/u/f46/16/46/16/61/google10.png" border="0">
...
<a title=" Đăng lên FaceBook" target="_blank" href="http://www.facebook.com/share.php?u=http://dktb.net{TOPIC_URL}"><img src="http://i46.servimg.com/u/f46/16/46/16/61/facebo10.png" border="0">
...
<a title=" Đăng lên TangVn" target="_blank" href="http://www.tagvn.com/submit?url=http://dktb.net{TOPIC_URL}"><img src="http://i46.servimg.com/u/f46/16/46/16/61/tagvn10.gif" border="0">
...
<a title="In trang này" href="javascript:window.print()"><img src="http://i46.servimg.com/u/f46/16/46/16/61/print10.gif" border="0">
...
<span class="options-button"> <a href="javascript:vol(0)" onClick="delpre();repfmvi($(this))">Trả lời nhanh
...
class=" main-content frm listVer4">
...
$('#cungchuyenmuc1 a.topictitle').wrap("<li>
...
kt.replaceWith('<a onmouseover="show_tooltip(this, $(this).parent().next().html(), \'FMvi.Org\')" href="' + kt.attr("href") + '" class="topictitle">' + kt.text() + '
...
$('#cungchuyenmuc1').html('<p><font face="Courier New"><font color="red">Có lỗi xảy ra trong quá trình tải dữ liệu.
...
$('#bailienquan1 .topictitle').wrap("<li>
...
it.replaceWith('<a onmouseover="show_tooltip(this, $(this).parent().next().html(), \'FMvi.Org\')" href="' + it.attr("href").slice(0, it.attr("href").indexOf("?")) + '" class="topictitle">' + it.text() + '
...
error: function (jqXHR, textStatus, errorThrown) {
$('#bailienquan1').html('<p><font face="Courier New"><font color="red">Có lỗi xảy ra trong quá trình tải dữ liệu.
...
$(".fmviToggle .main .clearfix").prepend('<span class="collapsePost" style="float:right"><img src="http://i73.servimg.com/u/f73/15/93/84/93/i_tabs10.png" alt="fmClose" /><img style="display:none" src="http://i73.servimg.com/u/f73/15/93/84/93/i_tabs11.png" alt="fmOpen" />
...
<div id="specificatii_center" align="center"><ul id="specificatii"><li>•  Không spam. Xem rõ nội quy chung tại <a href="t2160-topic" rel="nofollow"><strong>Đây
