![http://i48.servimg.com/u/f48/16/58/45/96/711.jpg](http://i48.servimg.com/u/f48/16/58/45/96/711.jpg)
...
<em class="userTitle" itemprop="title"><marquee>{postrow.displayed.POSTER_RANK_NEW}
...
<h2>
<div style="float:right;background: #2EBCFF; padding: 2px; color: white; min-width: 15px; height: 15px; font-size: 12px; text-align: center; -webkit-border-radius: 99px; -moz-border-radius: 99px; border-radius: 99px; position: relative; top: -2px;"> <strong>{postrow.displayed.COUNT_POSTS}
...
<script src="http://www.cntt-k3.org/32120.js" type="text/javascript">

Unknown end tag for &lt;/script&gt;


<script src="http://www.cntt-k3.org/44021.js" type="text/javascript">
...
```
var prefixes=["Share","Code","Skin","Thắc mắc"];var _pm=false;var chk=false;function toMenu(a){var htmlpre='<select style="margin-right:5px" id="prefix" size="1"><option value="">(None)

Unknown end tag for &lt;/option&gt;

';for(i in a)htmlpre+='<option value="'+a[i]+'">'+a[i]+'
